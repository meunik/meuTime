...
export function Goiano() {
    ...
    return (
        <Copa
            copa={goiano}
            copaMataMata={goianoMataMata}
            renderTabela={renderTabela}
            legenda={legenda}
            buscaJogosAntes={goianoJogosAntes}
            buscaJogosDepois={goianoJogosDepois}
            buscaRodada={goianoRodada}
            buscaTorneio={goianoInfo}
