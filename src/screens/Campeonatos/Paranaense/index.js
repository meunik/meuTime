...
import {
    ...
    paranaense,
    paranaenseMataMata,
    paranaenseJogosAntes,
    paranaenseJogosDepois,
    paranaenseRodada,
...
export function Paranaense() {
    ...
    return (
        <Copa
            copa={paranaense}
            copaMataMata={paranaenseMataMata}
            renderTabela={renderTabela}
            legenda={legenda}
            buscaJogosAntes={paranaenseJogosAntes}
            buscaJogosDepois={paranaenseJogosDepois}
            buscaRodada={paranaenseRodada}
            buscaTorneio={paranaenseInfo}
