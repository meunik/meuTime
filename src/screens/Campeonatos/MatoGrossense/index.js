...
import {
    matoGrossenseInfo,
    matoGrossense,
    matoGrossenseMataMata,
    matoGrossenseJogosAntes,
    matoGrossenseJogosDepois,
    matoGrossenseRodada,
...
export function MatoGrossense() {
    ...
    return (
        <Copa
            copa={matoGrossense}
            copaMataMata={matoGrossenseMataMata}
            renderTabela={renderTabela}
            legenda={legenda}
            buscaJogosAntes={matoGrossenseJogosAntes}
            buscaJogosDepois={matoGrossenseJogosDepois}
            buscaRodada={matoGrossenseRodada}
            buscaTorneio={matoGrossenseInfo}
